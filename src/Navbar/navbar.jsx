...
let Navbar = ()=>{
   ...
   let {bool,setBool} = useContext(Context)
    return  <div className=" nav  w-full  mt-2   rounded-full bg-white flex md:justify-around items-center md:flex-row justify-between p-4   ">
          ...
          <button className=" hidden md:block bg-green-950 rounded-full w-30  p-2  text-white cursor-pointer">Sign Up</button>
           <FaBars onClick={()=>{setBool(true)}}  className=" md:hidden  text-3xl cursor-pointer text-black"/> 
