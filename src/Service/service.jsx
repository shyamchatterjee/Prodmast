    ...
    <div className=" mt-4 w-full flex flex-col gap-3">
      ...
      <div className="w-full flex justify-center items-center flex-col gap-4 p-2 md:justify-center md:gap-16 md:flex-row">
        ...
        <div className="w-full  bg-white rounded-2xl p-3 md:w-96">
          ...
          <p>
            Boost factory efficiency and productivity with our innotive
            solutions.
          </p>
      ...
      <div className="w-full bg-black p-5 md:p-20   flex flex-col gap-2 text-white">
        <div className="mt-10  flex  flex-col justify-center items-center ">
          <p style={{ fontSize: "30px" }}>Tailored Plans for Your </p>
        ...
        <div className="w-full flex flex-col  items-center gap-2 md:gap-5 justify-center md:flex-row">
          <div className="color w-50 rounded-2xl p-2 md:w-80  md:p-3">
            ...
            <p>
              This package offers the basic feactures you need to get started
            </p>
            <p>$39 /month</p>
            <button className=" mt-2 cursor-pointer w-full p-1 bg-transparent border-1 rounded-2xl border-b-green-200">
              Get Started
            </button>
            <p
              style={{
        ...
        <div className="box3 mt-6 w-full p-4 bg-green-950 p-2 rounded-2xl flex items-center flex-col gap-2">
          ...
          <button className="box text-black p-1 w-30 rounded-2xl font-bold cursor-pointer">
            Get Started
          </button>
        </div>
      </div>
      <div className="w-full p-4 flex flex-col gap-2 justify-center bg-white items-center md:flex-row ">
        <div className="w-full p-2   rounded-2xl md:w-70">
          <h2 style={{ fontSize: "22px", fontWeight: "bold" }}>
            Empowering Top Companies with Seamless Intregrations
          </h2>
          <p>
            Experience seamless connetions with our innovative solution,
            designed to effortlessly integrate with your existing systems,
            enhance productivly, and drive your buuiness towards greater success
          </p>

          <button className="boxss mt-2 text-black p-2 w-30 rounded-2xl font-bold cursor-pointer">
            work with us
          </button>
        </div>
