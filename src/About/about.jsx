    ...
    return <div className="box2 w-full p-3  flex flex-col gap-2 ">
            ...
            <div className="mt-7 w-full flex flex-row  flex-wrap gap-3 justify-center md:flex-wrap" >
                  <div className="box3 w-35 p-3  flex flex-col rounded-2xl gap-2 text-white md:w-45 ">
                       ...
                       <p className="pera">Details on production, assembly, capacity, and product types</p>
                  </div>
                   <div className="box3 w-35 p-3  flex flex-col rounded-2xl gap-2 text-white md:w-45 ">
                       <div className="flex items-center justify-between">
                       ...
                       <p className="pera">Custom product creation with design and customization option</p>
                  </div>
                   <div className="box3 w-35 p-3  flex flex-col rounded-2xl gap-2 text-white md:w-45 ">
                       <div className="flex items-center justify-between">
                       ...
                       <p>Quality Control</p>
                       <p className="pera">Procedures and systems in place to ensure high product quality.</p>
                  </div>
                  <div className="box3 w-35 p-3  flex flex-col rounded-2xl gap-2 text-white md:w-45 ">
                       <div className="flex items-center justify-between">
