  ...
  return (
    <div id="home" className="mt-4 w-full flex flex-col items-center">
      ...
      <div className=" hidden md:block w-full md:flex  flex-wrap justify-center gap-2 items-center md:gap-8">
        <img
          src="https://img.freepik.com/premium-photo/industrial-factory-background-industry-pipe-rack-heat-chemical-manufacturing-equipment-steel-pipes_239711-11688.jpg"
          className="h-55 w-40 rounded-2xl md:h-55 md:w-40 "
          alt=""
        />
      ...
      <div className="block flex mt-4 justify-center items-center flex-row flex-wrap gap-2  box-border md:hidden">
        <img
          src="https://img.freepik.com/premium-photo/industrial-factory-background-industry-pipe-rack-heat-chemical-manufacturing-equipment-steel-pipes_239711-11688.jpg"
          className="h-50 w-28 rounded-2xl "
          alt=""
        />
